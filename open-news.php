...
<!-- Mirrored from eco-nature-html.cmsmasters.net/open-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Oct 2018 13:12:42 GMT -->
<head>
		<meta charset="UTF-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
		<link rel="shortcut icon" href="img/favicon-2.jpg" type="image/x-icon" />

		<title>Open News Profile </title>
							...
							<!--_________________________ Start Standard Profile _________________________ -->
									<article class="profile type-profile hentry">
										<div class="profile_content with_sidebar">
											<figure>
												<a href="admin/<?php echo $row['image4']; ?>" title="Karen Dawson" class="cmsms_img_link preloader highImg" data-rel="ilightbox[img_2473_554c72320ffdb]">
													<img width="820" height="490" src="admin/<?php echo $row['image4']; ?>" class="full-width" alt="Karen Dawson" title="Karen Dawson" />
												</a>
											</figure>
										...
										<div class="profile_sidebar">
											<div class="profile_details entry-meta">
												<h2 class="profile_details_title"><?php echo $row['news']; ?></h2>
												
												<div class="profile_details_item">
													<div class="profile_details_item_title">Date</div>
													<div class="profile_details_item_desc">
													    <div class="pl_subtitle" style="color:black;"><i class="far fa-calendar-alt"></i>&nbsp <?php echo $res; ?></div>
													</div>
												</div>
											...
											<div class="profile_social_icons">
												<ul class="profile_social_icons_list">
													<li><a href="#" class="cmsms-icon-twitter-circled" title=""></a></li><li><a href="#" class="cmsms-icon-facebook-circled" title=""></a></li><li><a href="#" class="cmsms-icon-flickr-circled" title=""></a></li><li><a href="#" class="cmsms-icon-vimeo-circled" title=""></a></li><li><a href="#" class="cmsms-icon-linkedin-circled" title=""></a></li>
												</ul>
											</div>
										</div>
										<div class="cl"></div>
...
<!-- Mirrored from eco-nature-html.cmsmasters.net/open-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Oct 2018 13:12:43 GMT -->
</html>
