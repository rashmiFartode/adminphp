...
<head>
		...
		<title>Contacts | Punarnava</title>
					...
					<div class="headline cmsms_color_scheme_first">
						<div class="headline_outer">
							...
							<div class="headline_inner align_center">
								<div class="headline_aligner"></div><div class="headline_text headline_subtitle"><h1 class="entry-title">Contact Info</h1>
								<!--<h5>Always here to Provide Services</h5></div>-->
							</div>
						</div>
					</div>
									...
									<div class="cmsms_row_inner cmsms_row_fullwidth">
										<div class="cmsms_row_margin">
											<div class="cmsms_column one_first">
												...
												<!--		jQuery("#google_map_555091c556dfc").gMap({ -->
												<!--			address: "Brooklyn", -->
												<!--			maptype: "ROADMAP", -->
												<!--			zoom: 14, -->
												<!--			scrollwheel: true, -->
												...
												<!--	});-->
												<!--</script>-->
												<div id="google_map_555091c556dfc" class="gMap">
												    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1860.981769595578!2d79.07223690807862!3d21.11401974648809!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bd4bf7b87b5842b%3A0xdcce4330dbbc3d85!2sHindustan+Colony%2C+Samarth+Nagar+East%2C+Nagpur%2C+Maharashtra+440015!5e0!3m2!1sen!2sin!4v1543384676088" width="600" height="450" frameborder="0" style="border:0;width:100%;padding:3em;" allowfullscreen></iframe>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											<div class="cmsms_column one_half">
												<h3 id="cmsms_heading_555091c557200" class="cmsms_heading" style="color:black;text-transform: uppercase; ">Send Message</h3>
													...
													<div class="cmsms-form-builder">
														<div class="cmsms_notice cmsms_notice_success cmsms-icon-check-2 success_box widgetinfo" style="display:none;">
															...
															<div class="notice_content">
																<p style="color:#979ca4;">Thank You! <br />Your message has been sent successfully.</p>
															</div>
														</div>
														<script type="text/javascript">
															jQuery(document).ready(function () { 
...
<?php 
    if ($_POST["contact_email"]<>'') { 
        $ToEmail = 'info@punarnava.co.in';
        $EmailSubject = "For contact to punarnava"; 
        ...
        $MESSAGE_BODY .= "\nWebsite: ".$_POST["contact_url"]."<br>";
       
        $MESSAGE_BODY .= "\nSubject: ".$_POST["contact_subject"]."<br>";
       
        $MESSAGE_BODY .= "\nMessage: ".nl2br($_POST["contact_message"]).""; 
        
        $send = mail($ToEmail, $EmailSubject, $MESSAGE_BODY, $mailheader) or die ("Failure"); 
...
?>
														<form method="post" id="contactform" action="contacts.php" enctype="form-data/multipart">
															<div class="form_info cmsms_input one_half">
																<label for="contact_name" style="color:black;">Name <span class="color_3">*</span></label>
															...
															<div class="form_info cmsms_input one_half">
																<label for="contact_email" style="color:black;">Email <span class="color_3">*</span></label>
																<div class="form_field_wrap">
																	<input type="text" name="contact_email" id="contact_email" value="" size="22" tabindex="4" class="validate[required,custom[email]]" />
																</div>
															</div>
															<div class="form_info cmsms_input one_half">
																<label for="contact_url" style="color:black;">Website</label>
																<div class="form_field_wrap">
																	<input type="text" name="contact_url" id="contact_url" value="" size="22" tabindex="5" class="validate[custom[url]]" />
																</div>
															</div>
															<div class="form_info cmsms_input one_half">
																<label for="contact_subject" style="color:black;">Subject <span class="color_3">*</span></label>
																<div class="form_field_wrap">
															...
															<div class="form_info cmsms_textarea one_first">
																<label for="contact_message" style="color:black;">Message <span class="color_3">*</span></label>
																<div class="form_field_wrap">
															...
															<div class="form_info submit_wrap">
															    <input type="submit" name="submit" value="Send message" class="cmsms_button" id="contact_form_formsend" tabindex="8">
											...
											<div class="cmsms_column one_half">
												<h3 id="cmsms_heading_555091c5584b3" class="cmsms_heading" style="color:black;text-transform: uppercase;" >Contact Info</h3>
												<div class="cmsms_text">
													<p style="color:#979ca4;"> Punarnava Ecological Services and Eco-design Solutions</p>
												</div>
												<ul id="cmsms_icon_list_items_555091c558691" class="cmsms_icon_list_items cmsms_icon_list_type_list cmsms_icon_list_pos_left cmsms_color_type_border">
													<li id="cmsms_icon_list_item_555091c5587e4" class="cmsms_icon_list_item cmsms-icon-location-7" style="color:#979ca4;">"Punarnava", Plot Number 35-B, Hindusthan Colony, Off Amravati Road, Nagpur - 4440033
 </li>
													<li id="cmsms_icon_list_item_555091c558872" class="cmsms_icon_list_item cmsms-icon-mobile-6" style="color:#979ca4;">+91 9823612468</li>
															<li id="cmsms_icon_list_item_555091c558872" class="cmsms_icon_list_item cmsms-icon-mobile-6" style="color:#979ca4;">+91 9225214377</li>
													<li id="cmsms_icon_list_item_555091c5588fb" class="cmsms_icon_list_item cmsms-icon-mail-7" style="color:#979ca4;">info@punarnava.co.in</li>
												</ul>
											</div>
										</div>
									</div>
						...
						<div id="cmsms_row_555091c558a73" class="cmsms_row cmsms_color_scheme_first" data-stellar-background-ratio="0.5">
							<div class="cmsms_row_outer_parent">
								<div class="cmsms_row_outer">
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
...
<!-- Mirrored from eco-nature-html.cmsmasters.net/contacts.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Oct 2018 13:18:40 GMT -->
</html>
