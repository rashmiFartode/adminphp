...
if(isset($_POST['add']))
{
 $errors = validate_event();
  if(count($errors)==0)
  {
     ...
     $sql="INSERT INTO projects SET title='".$_POST['title']."',image2='$dest',description='".$_POST['description']."',created=NOW()";
                ...
                <div class="login-form">
                    <form method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title" placeholder="Project Title" value="<?php echo isset($_POST['title'])? $_POST['title']:'';?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"  placeholder="Project Description" name="description" value="<?php echo isset($_POST['description'])? $_POST['description']:'';?>" />
