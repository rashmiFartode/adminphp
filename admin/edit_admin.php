...
$sql ="update admin SET first_name='$first_name',last_name='$last_name',email='$email',mobile_no='$mobile_no' where id=".$_GET['id'].""; 
	//print_r($sql);exit;
	$result = mysqli_query($con,$sql);
		if(mysqli_affected_rows($con))
		{
				echo("<SCRIPT LANGUAGE='JavaScript'>
				window.alert('Succesfully Record Updated Succesfully')
				window.location.href='adminrecord.php';
				</SCRIPT>");
		}
		else
			echo "Could not update guest.";
	}
            ...
            <div class="login-content">
				...
				<form enctype="multipart/form-data" method="post">
						...
						<div class="form-group">
                            ...
                            <input type="text" class="form-control" name="mobile_no"  placeholder="Mobile_no" value="<?php echo isset($_POST['mobile_no'])? $_POST['mobile_no']:'';?>">
