...
{
	$errors = validate_event_news_edit();
	if(count($errors) == 0)
	{
		$rand = rand();
  		$src = $_FILES['image4']['tmp_name'];
		$dest = 'images/news/'.$rand.$_FILES['image4']['name'];
		$photo = '';
		if(move_uploaded_file($src,$dest))
			$photo = $rand.$_FILES['image4']['name'];

		$sql = "UPDATE news SET news='".$_POST['news']."',description='".$_POST['description']."',date='".$_POST['date']."', modified=NOW()";
		
		if(!empty($photo) || $photo != '')
			$sql .= ",image4='$dest' WHERE id=".$_GET['id'];
		else
                ...
                <div class="login-form">
                    <form method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="news" placeholder="News Title" value="<?php echo isset($_POST['news'])? $_POST['news']:'';?>">
						...
						<div class="form-group">
                            ...
                            <input type="file"  name="image4" selected><?php echo $_POST['image4']; ?>
 				<?php if(!empty($_POST['image4'])) { ?>
					<img src="<?php echo $_POST['image4']; ?>" height="60px" width="100px">
				<?php } ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"  placeholder="News Details" name="description" value="<?php echo isset($_POST['description'])? $_POST['description']:'';?>" />
