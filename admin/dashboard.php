...
<head>
    ...
    <title>Dashboard | Punar Nava</title>
           ...
           <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-1">
                    <div class="card-body pb-0">
                        ...
                        <h4 class="mb-0">
						<?php $count = mysqli_query($con, "select * from admin"); 
								$res = mysqli_num_rows($count);
						?>
                            <span class="count"><?php  echo $res; ?></span>
                        </h4>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-2">
                    <div class="card-body pb-0">
                        ...
                        <h4 class="mb-0">
						<?php $count = mysqli_query($con, "select * from testimonial"); 
								$res1 = mysqli_num_rows($count);
						?>
                            <span class="count"><?php echo $res1; ?></span>
                        </h4>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-3">
                    <div class="card-body pb-0">
                        ...
                        <h4 class="mb-0">
						<?php $count = mysqli_query($con, "select * from slider"); 
								$res3 = mysqli_num_rows($count);
						?>
                            <span class="count"><?php echo $res3; ?></span>
                        </h4>
                        <p class="text-light">Slider Images</p>
