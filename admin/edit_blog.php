...
{
	$errors = validate_event_blog_edit();
	if(count($errors) == 0)
	{
		$rand = rand();
		...
		if(move_uploaded_file($src,$dest))
			$photo = $rand.$_FILES['image3']['name'];

		$sql = "UPDATE blog SET blog_name='".$_POST['blog_name']."',details='".$_POST['details']."',date='".$_POST['date']."', modified=NOW()";
		
		if(!empty($photo) || $photo != '')
			$sql .= ",image3='$dest' WHERE id=".$_GET['id'];
		else
                ...
                <div class="login-form">
                    <form method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
                            ...
                            <input type="file"  name="image3" selected><?php echo $_POST['image3']; ?>
 				<?php if(!empty($_POST['image3'])) { ?>
					<img src="<?php echo $_POST['image3']; ?>" height="60px" width="100px">
				<?php } ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"  placeholder="Blogs Details" name="details" value="<?php echo isset($_POST['details'])? $_POST['details']:'';?>" />
