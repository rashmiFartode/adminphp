...
{
	$errors = validate_event_gallery_edit();
	if(count($errors) == 0)
	{
		$rand = rand();
		...
		if(move_uploaded_file($src,$dest))
			$photo = $rand.$_FILES['image1']['name'];

		$sql = "UPDATE gallery SET caption='".$_POST['caption']."', modified=NOW()";
		
		if(!empty($photo) || $photo != '')
			$sql .= ",image1='$dest' WHERE id=".$_GET['id'];
		else
                ...
                <div class="login-form">
                    <form method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
                            ...
                            <input type="file"  name="image1" selected><?php echo $_POST['image1']; ?>
 			         	<?php if(!empty($_POST['image1'])) { ?>
				        	<img src="<?php echo $_POST['image1']; ?>" height="60px" width="100px">
			        	<?php } ?>
                        ...
                        <div class="form-group">
                            <label>Caption</label>
                            <input type="text" class="form-control"  placeholder="Caption" name="caption" value="<?php echo isset($_POST['caption'])? $_POST['caption']:'';?>" />
