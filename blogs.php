					...
					<div class="headline cmsms_color_scheme_first">
						<div class="headline_outer">
							...
							<div class="headline_inner align_center">
								<div class="headline_aligner"></div><div class="headline_text headline_subtitle"><h1 class="entry-title">Blogs</h1>
								...
								<div class="cmsms_row_outer">
									<div class="cmsms_row_inner">
										<div class="cmsms_row_margin">
											...
											<?php 
		                                          $sel = mysqli_query($con, "select * from blog");
					                         ...
					                         ?>	    
													...
													<article class="one_third format-profile">
														<div class="pl_img">
															<figure>
																<a href="open-profile.php?id=<?php echo $row['id']; ?>">
																	<img width="580" height="390" src="admin/<?php echo $row['image3']; ?>" class="attachment-blog-masonry-thumb" alt="Caroline Gerwig" title="Caroline Gerwig" />
																</a>
															</figure>
														</div>
														<div class="pl_content">
															<h2 class="entry-title">
																<a href="open-profile.php?id=<?php echo $row['id']; ?>" style="color:black;"><?php echo $row['blog_name']; ?></a>
															</h2>
															<h5 class="pl_subtitle" style="color:black;"><i class="far fa-calendar-alt"></i>&nbsp <?php echo $res; ?></h5>
															<div class="entry-content" style="color:black;"><?php echo $row['details']; ?></div>
														</div>
														<div class="pl_social">
