...
<head>
		...
		<title>About Us | Punarnava</title>
...
<!-- _________________________ Start Page _________________________ -->
			...
			<!-- _________________________ Start Middle _________________________ -->
					...
					<div class="headline cmsms_color_scheme_first">
						<div class="headline_outer">
							...
							<div class="headline_inner align_center">
								<div class="headline_aligner"></div><div class="headline_text headline_subtitle"><h1 class="entry-title">About Us</h1>
								<!--<h5>Know more About US</h5></div>-->
							</div>
						</div>
					</div>
				...
				<!--_________________________ Start Content _________________________ -->
						...
						<!--					<div class="cmsms_column one_first">-->
												<!--<h3 id="cmsms_heading_5548a7b764c0c" class="cmsms_heading">About Us</h3>-->
						<!--					</div>-->
						<!--				</div>-->
						<!--			</div>-->
						<!--		</div>-->
						    ...
						    <div class="container">
						        <div class="row pt-5 pb-5">
						            <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6">
						                <img src="admin/images/gallery/1546812348Green Butterfly.jpg" class="shadow bg-white rounded" alt="Present for You" title="Collection" style="width:100%;height:300px;">
						            </div>
						            <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6">
    ...
    text-indent: 2pc;
    line-height: 2;
    color: gray;">Every place has its own needs, which can be studied and recognised by experts and measures can be undertaken to increase the pace at which Nature can do the restoration work. Our natural resources are dwindling at an alarming rate, and it is the duty of us all to do our own bit to restore the natural balance. </p>
						            </div>
						            <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6">
						                <img src="admin/images/gallery/338420690Indian-roller.jpg" class="shadow bg-white rounded" alt="Present for You" title="Collection" style="width:100%;height:300px;">
						            </div>
						      </div>
						      <div class="row pt-5 pb-5">
						            <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6">
						                <img src="admin/images/gallery/1558758145Owl.jpg" class="shadow bg-white rounded" alt="Present for You" title="Collection" style="width:100%;height:300px;">
						            </div>
						            <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6">
						                <p class="text-justify " style="font-size: larger;
    text-indent: 2pc;
    ...
    color: gray;">
						...
						<!--                <div class="card">-->
      <!--                                    <img class="card-img-top" src="https://www.thebetterindia.com/wp-content/uploads/2015/06/1.png" style="height: 215px;" alt="Card image cap">-->
      <!--                                    <div class="card-body">-->
      <!--                                      <p class="card-text text-justify">Nature Rejuvenation is an art. If one wishes to restore / improve any vacant land, agricultural field or a patch of degraded jungle, one needs to assess the native / local level natural attributes at and around the given site. One needs to understand the guidelines and framework suggested by Nature in order to succeed in such an endeavour.</p>-->
      <!--                                    </div>-->
      <!--                                  </div>-->
						<!--                <div class="card">-->
      <!--                                    <div class="card-body">-->
      <!--                                      <p class="card-text text-justify">Every place has its own needs, which can be studied and recognised by experts and measures can be undertaken to increase the pace at which Nature can do the restoration work. Our natural resources are dwindling at an alarming rate, and it is the duty of us all to do our own bit to restore the natural balance. </p>-->
      <!--                                    </div>-->
      <!--                                    <img class="card-img-top" style="height: 215px;" src="http://blog.nationalgeographic.org/wp-content/uploads/2015/01/Spot-billed-Duck-Satyam-Dave-Rajkot-Gujarat.jpg" alt="Card image cap">-->
      <!--                                  </div>-->
						<!--                <div class="card">-->
      <!--                                    <img class="card-img-top" style="height: 215px;" src="https://www.thebetterindia.com/wp-content/uploads/2015/06/3.png" alt="Card image cap">-->
      <!--                                    <div class="card-body">-->
      <!--                                      <p class="card-text text-justify">Many people residing in cities have a piece of land adjacent to the city or in some nearby village. Most often, due to lack of proper information and guidance, such people do not know how they can use these lands for restoring Nature. “Punarnava” can provide following services in this respect…</p>-->
      <!--                                    </div>-->
      <!--                                  </div>-->
      <!--                                  <div class="card">-->
      <!--                                    <div class="card-body">-->
      <!--                                      <p class="card-text text-justify">Every place has its own needs, which can be studied and recognised by experts and measures can be undertaken to increase the pace at which Nature can do the restoration work. Our natural resources are dwindling at an alarming rate, and it is the duty of us all to do our own bit to restore the natural balance. </p>-->
      <!--                                    </div>-->
      <!--                                    <img class="card-img-top"style="height: 215px;" src="http://adlertours.files.wordpress.com/2013/04/indian-robbin.jpg" alt="Card image cap">-->
      <!--                                  </div>-->
						<!--        </div>-->
						<!--    </div>-->
						<!--</section>-->
												...
												<div class="cmsms_profile horizontal">
													<article class="one_third format-profile">
														...
														<div class="pl_content">
															<h2 class="entry-title">
																<a href="open-profile.html">Caroline Gerwig</a>
															</h2>
															<h5 class="pl_subtitle">Volunteer</h5>
													...
													<article class="one_third format-profile">
														<div class="pl_img">
															<figure>
																<a href="open-profile.html">
																	<img width="580" height="390" src="img/images/Simon_Green_small.jpg" class="attachment-blog-masonry-thumb" alt="Simon Green" title="Simon Green" />
																</a>
															</figure>
														</div>
														<div class="pl_content">
